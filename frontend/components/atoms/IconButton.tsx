...
export default function IconButton({
    ...
    return (
        <TouchableOpacity disabled={disabled} style={[styleSheet.container, styleSheet.flex, {
            backgroundColor: backgroundColor,
            opacity: opacity,
            borderRadius: borderRadius, ...additionalStyles
        }]} onPress={onPress}>
            {icon && <View style={styleSheet.icon}>
                <MaterialIcon iconType={icon.iconType} size={icon.size} name={icon.name} color={icon.color}
                              opacity={icon.opacity}></MaterialIcon>
            </View>}
